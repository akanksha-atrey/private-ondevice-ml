...
python3 -m src.db_attack -model_type 'rf' -noise_bounds $noisebounds -exp_num_query true
python3 -m src.db_attack -model_type 'lr' -noise_bounds $noisebounds -exp_num_query true
python3 -m src.db_attack -model_type 'dnn' -noise_bounds $noisebounds -exp_num_query true
